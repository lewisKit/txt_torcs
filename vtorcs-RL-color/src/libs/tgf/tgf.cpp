...
static char *libDir = "";
static char *dataDir = "";
static char *raceconfig = "";
static char *trackInfo = "";
...
char * GetRaceConfig(void)
{
	return raceconfig;
}


void SetRaceConfig(char *buf)
{
	raceconfig = strdup(buf);
}
...
void SetTrackInfo(char *buf)
{
	trackInfo = strdup(buf);
}
